...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u2", `'${deployer.address}.boombox`], wallet_2.address),
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u2", `'${deployer.address}.boombox`], wallet_3.address),
            Tx.contractCall("boombox", "get-listing-in-ustx", ["u1"], wallet_2.address)
        ]);
        assertEquals(block.receipts.length, 4);
        assertEquals(block.height, 2);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u2000000", `'${deployer.address}.boombox`], wallet_2.address),
            Tx.contractCall("boombox", "buy-in-ustx", ["u1", `'${deployer.address}.boombox`], wallet_3.address),
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u2", `'${deployer.address}.boombox`], wallet_2.address),
            Tx.contractCall("boombox", "transfer", ["u1", `'${wallet_2.address}`, `'${wallet_3.address}`], wallet_2.address)
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("boombox", "toggle-enabled", [], deployer.address),
            Tx.contractCall("boombox", "claim", [], wallet_2.address),
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u2000000", `'${deployer.address}.boombox`], wallet_2.address),
            Tx.contractCall("boombox", "list-in-ustx", ["u1", "u4000000", `'${deployer.address}.boombox`], wallet_2.address),
            Tx.contractCall("boombox", "buy-in-ustx", ["u1", `'${deployer.address}.boombox`], wallet_3.address),
            Tx.contractCall("boombox", "get-owner", ["u1"], wallet_2.address)
        ]);
